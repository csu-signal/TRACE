...
parser.add_argument(
    ...
    default='F:\\Weights_Task\\Data\\Fib_weights_original_videos\\Group_01-sub2.mkv'
)
...
checkpoint = torch.load('C:\\GitHub\\Camera_Calibration\\offline_processor\\objectDetectionModels\\best_model-objects.pth', map_location=DEVICE)
