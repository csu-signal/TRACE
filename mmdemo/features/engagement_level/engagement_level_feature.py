...
class EngagementLevel(BaseFeature[EngagementLevelInterface]):
    ...
    def get_output(
        self, pose_event: PoseEventInterface, gaze_event: GazeEventInterface
    ):
        ...
        if not pose_event.is_new() and not gaze_event.is_new():
        ...
        if n >= 3:
            ...
            if self.engagement_level < 3:
                ...
                file.write(
                    ...
                    + ","
                    + str(
                        len(self.timers["gaze_positive"])
                        + len(self.timers["posture_positive"])
                    )
                    + " positive events"
                    + str(
                        len(self.timers["gaze_negative"])
                        + len(self.timers["posture_negative"])
                    )
                    + " negative events,"
                    + "behavioral engagemental level +1,"
                    + str(self.engagement_level)
                    + "\n"
                )
            else:
            ...
            if timer == "gaze_positive":
                ...
                if count > 0:
                    file.write(
                        ...
                        + " negative events,"
                        + str(count)
                        + " gaze positive events are no more active,"
                        + str(self.engagement_level)
                        + "\n"
                    )
                ...
                if count > 0:
                    file.write(
                        ...
                        + " negative events,"
                        + str(count)
                        + " gaze negative events are no more active,"
                        + str(self.engagement_level)
                        + "\n"
                    )
                ...
                if count > 0:
                    file.write(
                        ...
                        + " negative events,"
                        + str(count)
                        + " posture positive events are no more active,"
                        + str(self.engagement_level)
                        + "\n"
                    )
            else:
                ...
                if count > 0:
                    file.write(
                        ...
                        + " negative events,"
                        + str(count)
                        + " posture negative events are no more active,"
                        + str(self.engagement_level)
                        + "\n"
                    )
        file.close()
