...
class DpipObject(BaseFeature[DpipObjectInterface3D]):
    ...
    def initialize(self):
        ...
        self.device = DEVICE
        self.objectModel = create_model(num_classes=NUM_CLASSES) # TODO DPIP classes
    ...
    def get_output(
        ...
        return DpipObjectInterface3D(objects=objects)
    ...
    def getDescription(self, classId):
        ...
        """
        # TODO update with DPIP classes
        if classId == 0:
            return DpipGamrTarget.RED_BLOCK

        elif classId == 1:
            return DpipGamrTarget.YELLOW_BLOCK

        elif classId == 2:
            return DpipGamrTarget.GREEN_BLOCK

        elif classId == 3:
            return DpipGamrTarget.BLUE_BLOCK

        elif classId == 4:
            return DpipGamrTarget.PURPLE_BLOCK

        return DpipGamrTarget.UNKNOWN
