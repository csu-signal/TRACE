...
UTTERANCE_PATH = "G:\\DPIP\\GAMR\\Utterances\\Group_{0:02}.csv"
AUDIO_PATH = "G:\\DPIP\\DPIP_Azure_Recordings\\Group_Test_{0:02}-audio1.wav"
OBJECT_PATH = (
    "G:\\Weights_Task\\Data\\6DPose\\Group{0}\\Group_{0:02}-objects_interpolated.json"
)
GAMR_PATH = "G:\\DPIP\\GAMR\\CSV\\Group_{0:02}_merge_CM.csv"
