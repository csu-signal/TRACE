...
def main(device_index=None, done=None):
    ...
    recorder = Process(target=record_chunks, args=(device_index, queue, done))
    processor = Process(target=process_chunks, args=(device_index, queue, done), kwargs={"print_output":True})
