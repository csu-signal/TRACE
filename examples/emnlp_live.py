...
if __name__ == "__main__":
    ...
    audio1 = MicAudio(device_id=10, speaker_id="Participant 1")
    audio2 = MicAudio(device_id=12, speaker_id="Participant 2")
    audio3 = MicAudio(device_id=13, speaker_id="Participant 3")
