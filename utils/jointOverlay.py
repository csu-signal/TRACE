...
parser.add_argument('--maxHands', nargs='?', default=2)
parser.add_argument('--minDetectionConfidence', nargs='?', default=0.3)
parser.add_argument('--minTrackingConfidence', nargs='?', default=0.3)
parser.add_argument('--videoPath', nargs='?', default="C:\\Users\\vanderh\Downloads\\jack-washing-hands.MP4")
...
while cap.isOpened():
    ...
    cv2.imwrite("C:\\Users\\vanderh\\Downloads\\overlay\\" + str(frameCount + args.initialFrame) + "handWashing.png", frame) 
